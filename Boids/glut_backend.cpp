...
static void CamCB(int Key, int x, int y)
{
    s_pCallbacks->CamCB(Key, x, y);
}
...
static void MouseTrackCB(int x, int y)
{
    s_pCallbacks->MouseTrackCB(x, y);
}


static void RenderCB()
{
    s_pCallbacks->RenderCB();
}
...
static void InitCallbacks()
{
    ...
    glutIdleFunc(IdleCB);
    glutSpecialFunc(CamCB);
    glutPassiveMotionFunc(MouseTrackCB);
